                     ...
                     <div className="card-body address_card">
                        <div className="card-header py-2">
                           ...
                           <div className="btn-toolbar d-inline float-right">
                              <a href={`/edit`}
                                 ...
                                 className="btn btn-link d-inline">Edit</a>
                              <a href={`/delete`}
                                 onClick={e => deleteAddress(e, address)}
                                 className="btn btn-link d-inline">Delete</a>
                           </div>
                        </div>
                        <p>
                           Name: {address.name}<br/>
                           Phone: {address.phone_one}<br/>
                           District: {address.phone_three}<br/>
                        ...
                        </p>
                        {
                           ...
                           <a href={`/ship-here`}
                              ...
                              className="btn_ship_here">Ship here</a>
                        }
                     </div>
                  </div>
               )
