            ...
            <div className="row">
               <div className="col text-center">
                  <a href="/category" className="nav-link toggleMobileMenu">
                     <span className=" sticky_nav_icon"><i className="icon-bars"/></span>
                  </a>
               </div>
               <div className="col text-center">
                  <Link className="nav-link" to="/dashboard">
                     <span className=" sticky_nav_icon"><i className="icon-user"/></span>
                  </Link>
               </div>
               <div className="col text-center">
                  <Link className="nav-link" to="/">
                     <span className="sticky_nav_icon"><i className="icon-home"/></span>
                  </Link>
               </div>
               <div className="col text-center">
                  <a className="nav-link" href="https://m.me/306375176046078" rel="noreferrer" target="_blank">
                     <span className=" sticky_nav_icon"><i className="icon-facebook-messenger"/></span>
                  </a>
               </div>
               <div className="col text-center">
                  <a className="nav-link" href={`tel:${office_phone}`}>
                     <span className=" sticky_nav_icon"><i className="icon-phone"/></span>
                  </a>
               </div>
            </div>
         </div>
