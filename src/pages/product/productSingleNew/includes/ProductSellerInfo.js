...
const ProductSellerInfo = (props) => {
   ...
   if (loading) {
      return (
         <div className="text-center py-5">
            ...
            <button type="button" onClick={e => loadProductSellerInformation(e)} className="btn btn-link"> Cancel</button>
         </div>
      )
   }
   ...
   if (_.isEmpty(sellerInfo)) {
      return (
         <div className="text-center py-5">
            <button type="button" onClick={e => loadProductSellerInformation(e)} className="btn btn-default">Show Seller Info</button>
         </div>
      )
   }
