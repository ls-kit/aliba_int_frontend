...
import {
   activeProductAllConfigurators, colorAttributes,
                  ...
                  <div className="product-nav product-nav-thumbs">
                     {
                        getGroupAllAttributes(PropertyName).map((Attribute, index2) =>
                           <a
                              ...
                              className={`text-center ${isSelect(Attribute) ? 'isSelect' : ''} ${Attribute.MiniImageUrl ? "hasImage": "noImage"}`}
