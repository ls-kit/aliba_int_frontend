...
const OrderDetails = props => {
   ...
   return (
      <main className="main bg-gray">
         <Breadcrumb current="Order details" collections={[
                        ...
                        <div className="card-body pt-5 px-5 py-4">
                           <table className="table table-borderless" style={{tableLayout: "fixed"}}>
                              ...
                              <tr>
                                 ...
                                 <td></td>
                                 <td>
                                    <p className="m-0"><b>UNPAID</b></p>
                                    <p className="m-0"><span className="mr-2">Method:</span>
                                       {order.pay_method === 'bkash_payment' && `Bkash`}
                                       {order.pay_method === 'nagad_payment' && `Nagod`}
                                    </p>
                                    <p className="m-0"><span className="mr-2">Wallet:</span>
                           ...
                           <table className="table table-bordered table-cart">
                              ...
                              <tbody>
                              {
                                 orderItems.length > 0 ?
                                    ...
                                    :
                                    <tr>
                                       <td colSpan={6} className="text-center bg-lighter">You have no cart!</td>
                                    </tr>
                              ...
                              <tr className="summary-total">
                                 <td colSpan={5} className="text-right">Need To Pay:</td>
                                 <td className="text-right">{`${currency} ${order.needToPay}`}</td>
                              </tr>
                              <tr className="summary-total">
                                 <td colSpan={5} className="text-right">Due Amount:</td>
