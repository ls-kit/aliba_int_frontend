...
import {filter_children_cats, find_cat_by_slug, find_cat_parent, goPageTop, slugToKey} from "../../utils/Helpers";
...
const LoadShopProducts = (props) => {
   ...
   const loadingProduct = (loadOffset = 0) => {
      ...
      loadCategoryProducts(category_slug, loadOffset, perPage)
         .then(response => {
