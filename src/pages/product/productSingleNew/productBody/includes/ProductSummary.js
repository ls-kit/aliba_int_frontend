...
const ProductSummary = props => {
   ...
   return (
      <table className="table table-sm table-bordered product_summary_table">
         <tbody>
         <tr>
            <td className="bg-gray text-center" colSpan={2}><b>CHINA TO BANGLADESH</b></td>
         </tr>
         <tr>
         ...
         <tr>
            <td colSpan={2}>
               <span className="text-danger">উপরে উল্লেখিত মুল্য শুধুমাত্র চায়না থেকে বাংলাদেশে আসার ক্রয়মুল্য, পণ্য আসার পর লোকাল শিপিং চার্জ আলাদা যোগ হবে।</span>
            </td>
         </tr>
         </tbody>
      </table>
