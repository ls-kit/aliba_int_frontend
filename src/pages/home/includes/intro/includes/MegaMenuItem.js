...
import { filter_children_cats, goPageTop, loadAsset } from "../../../../../utils/Helpers";
    ...
    <div>
      ...
      {showLoad && (
        <div className='pr-4 py-2' style={{ textAlign: "end" }}>
          <button className='btn btn-default cat-see' onClick={() => handleShowLoad()}>
            See All
          </button>
        </div>
      )}
      {!showLoad && (
        <div className='pr-4 py-2' style={{ textAlign: "end" }}>
          <button className='btn btn-default cat-see ' onClick={() => handleLessLoad()}>
            See Less
          </button>
        </div>
      )}
