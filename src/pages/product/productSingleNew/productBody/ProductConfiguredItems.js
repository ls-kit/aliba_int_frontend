...
import {getProductAttributes, getProductPrice, is_size} from "../../../../utils/CartHelpers";
   ...
   const activeConfiguredItems = () => {
      ...
      if (!_.isEmpty(cartAttribute)) {
         returnValues = ConfiguredItems.filter(filter => {
            ...
            Configurators = Configurators.find(configAttr => configAttr.Pid === cartAttribute.Pid && configAttr.Vid === cartAttribute.Vid);
...
export default connect(mapStateToProps, {})(
   withRouter(ProductConfiguredItems)
);
