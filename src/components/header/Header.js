                        ...
                        auth.isAuthenticated ?
                           <div className="dropdown cart-dropdown">
                              ...
                              <div className="dropdown-menu dropdown-menu-right nav_customer_menus">
                                 ...
                                 <Link to="/dashboard/orders" className="dropdown-item">My Orders</Link>
                                 <Link to="/dashboard/account" className="dropdown-item">Account</Link>
                                 <a href={`/logout`} className="dropdown-item" onClick={e => props.authLogoutProcess(e)}>Logout</a>
                              </div>
                              {/* End .dropdown-menu */}
                           </div>
                           :
