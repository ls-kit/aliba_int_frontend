...
const AirFilter = () => {
  ...
  return (
    <div>
      <div className='mb15'>
        <div class='shippingBoxContainer mb05'>
          <div
          ...
          >
            ...
            ></input>
            <div>
              <p class='p-0'>By Air (12-24 Days)</p>
          ...
          >
            ...
            ></input>
            <div>
              <p class='p-0'>By Sea (48-72 Days)</p>
              <p className='p-0' style={{ fontWeight: "500", fontSize: "14px", marginTop: "0.5rem" }}>
                {" "}
                ৳ 100-350 per kg
              </p>
      ...
      >
        ...
        <div className='shippingBoxContainer mb05'>
          <div class='shippingBox mr05' style={{ background: "rgb(229, 217, 185)" }}>
            <p class='mb05'>৬৩০ টাকা প্রতি কেজি </p>
            <span>
              জুতা, ব্যাগ, জুয়েলারি, যন্ত্রপাতি, ব্যাটারি ব্যতীত ইলেক্ট্রনিক্স, ব্যাটারি ব্যতীত খেলনা, তরল ও
              ক্রিম ব্যতীত কসমেটিক্স, স্টিকার, সিরামিক, প্লাস্টিক, ধাতব, চামড়া, রাবার জাতীয় পণ্য ইত্যাদি।
            </span>
          </div>
          <div class='shippingBox' style={{ background: "rgb(229, 217, 185)" }}>
            <p class='mb05'>৭৬০ টাকা প্রতি কেজি</p>
            <span>
              পোশাক / বস্ত্র, ঘড়ি, সানগ্লাস, তরল এবং দাহ্য পদার্থ, ব্যাটারি জাতীয় যেকোনো পণ্য, ক্রিম এবং তরল
              কসমেটিক্স, রাসায়নিক দ্রব্য, খাদ্য, জীবন্ত উদ্ভিদ, বীজ, ডুপ্লিকেট ব্র্যান্ডেড পণ্য ইত্যাদি।
            </span>
          </div>
        </div>
      </div>
        ...
        <div className='shippingBoxContainer'>
          <div>
            <span style={{ fontSize: "14px" }}>
              সম্মানিত গ্রাহক, সি-শিপমেন্ট করার জন্য সর্বনিম্ন ৫০০ কেজি পণ্য অর্ডার করতে হবে। এক্ষেত্রে আপনি
              একাধিক পণ্য অর্ডার করতে পারবেন তবে প্রতিটি পণ্যের সর্বনিম্ন ওজন ২৫০ কেজি হতে হবে। পণ্যের
              ক্যাটাগরীর উপর নির্ভর করে শিপিং চার্জ নির্ধারণ করা হবে। অনুগ্রহপূর্বক অর্ডার করার পূর্বে আমাদের
              সি- শিপমেন্ট এক্সপার্টের সাথে যোগাযোগ করে চূড়ান্ত শিপিং চার্জ জেনে নিবেন।
            </span>
