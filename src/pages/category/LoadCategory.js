...
const LoadCategory = (props) => {
   ...
   return (
      <main className="main">
         ...
         <Breadcrumb current={subCategory.name} collections={[
                     ...
                     <div className="product_list_container">
                        <div className="toolbox">
                           <div className="toolbox-left">
                              <div
                                 className="toolbox-info">{category.name && category.name} {!_.isEmpty(subCategory) ? `/ ${subCategory.name}` : ''}</div>
                           </div>
                        </div>
...
export default connect(mapStateToProps, {loadSinglePage})(
   withRouter(LoadCategory)
);
