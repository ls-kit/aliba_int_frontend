...
const ShippingAddress = (props) => {
   const {currentAddress, setManageShipping, manageShipping} = props;
   ...
   return (
      <>
         <div
            ...
            tabIndex="-1"
            aria-labelledby="chooseAddressModalLabel" data-keyboard="true" aria-hidden="true">
                  ...
                  <div className="modal-header p-4">
                     <h5 className="modal-title" id="chooseAddressModalLabel">
                        ...
                        <a
                           ...
                           className="btn btn-link d-inline">Add New Address</a>
                     </h5>
                     <button
                        type="button"
                        onClick={() => closeModal()}
